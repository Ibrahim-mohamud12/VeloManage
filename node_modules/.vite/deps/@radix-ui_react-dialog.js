...
var RemoveScroll = React4.forwardRef(function(props, parentRef) {
  ...
  return React4.createElement(
    React4.Fragment,
    null,
    enabled && React4.createElement(SideCar, { sideCar: effectCar, removeScrollBar, shards, noRelative, noIsolation, inert, setCallbacks, allowPinchZoom: !!allowPinchZoom, lockRef: ref, gapMode }),
...
function RemoveScrollSideCar(props) {
  ...
  return React5.createElement(
    ...
    removeScrollBar ? React5.createElement(RemoveScrollBar, { noRelative: props.noRelative, gapMode: props.gapMode }) : null
  );
}
...
var DialogPortal = (props) => {
  ...
  return (0, import_jsx_runtime2.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React7.Children.map(children, (child) => (0, import_jsx_runtime2.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime2.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
